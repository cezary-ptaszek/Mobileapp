...
public class Encryption {
    ...
    private static class Builder {
        ...
        private Builder setKeyLength(int keyLength) {
        ...
        private Builder setIterationCount(int iterationCount) {
        ...
        private Builder setSecureRandomAlgorithm(String secureRandomAlgorithm) {
        ...
        private Builder setSecureRandom(SecureRandom secureRandom) {
        ...
        private Builder setIvParameterSpec(IvParameterSpec ivParameterSpec) {
        ...
        private Builder setDigestAlgorithm(String digestAlgorithm) {
